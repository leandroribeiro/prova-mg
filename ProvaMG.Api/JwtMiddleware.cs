...
namespace ProvaMG.Api
{
    public class JwtMiddleware
    {
        ...
        private void attachUserToContext(HttpContext context, IUsuarioRepository usuarioRepository, string token)
        {
            try
            {
                ...
                context.Items["Usuario"] = usuarioRepository.Obter(userId);
            }
            catch
            {
